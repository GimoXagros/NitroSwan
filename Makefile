...
ifeq ($(DSPICO_LAUNCH_DIAGNOSTIC),1)
DEFINES		+= -DDSPICO_LAUNCH_DIAGNOSTIC
endif
ifneq ($(PALETTE_RASTER_DIAGNOSTIC),)
DEFINES		+= -DPALETTE_RASTER_DIAGNOSTIC=$(PALETTE_RASTER_DIAGNOSTIC)
endif
ifeq ($(WSC_VIDEO_TRACE),1)
DEFINES		+= -DWSC_VIDEO_TRACE
endif
ifeq ($(RENDERER_ABI_SELF_TEST),1)
DEFINES		+= -DRENDERER_ABI_SELF_TEST
endif
